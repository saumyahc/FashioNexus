...
class _SellItemScreenState extends State<SellItemScreen>
  ...
  final TextEditingController _addressController =
      TextEditingController(); // Added for full address
  ...
  Future<void> _uploadItem() async {
    ...
    if (_sellerNameController.text.isEmpty ||
        _sellerEmailController.text.isEmpty ||
        _sellerPhoneController.text.isEmpty ||
        _sellerCityController.text.isEmpty ||
        _sellerStateController.text.isEmpty ||
    ...
    try {
      ...
      // Updated to use consistent field names that match the search logic
      await FirebaseFirestore.instance.collection("items").doc(itemId).set({
        ...
        // These fields match what the search function looks for
        ...
        "itemPrice": _itemPriceController.text.trim(),
        "imageUrl": imageUrl,
        "ownerId": user.uid,
        "type": "sell", // Important: Mark as sell type
        "createdAt": Timestamp.now(),
      });

      if (!mounted) return;
      _showSnackBar("Item uploaded successfully!", isError: false);
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildTextField(
                          ...
                          hint: 'City (e.g., Vadodara)',
                          icon: Icons.location_city,
                        ),

                        _buildTextField(
                          controller: _sellerStateController,
                          hint: 'State (e.g., Gujarat)',
